...
class ShortTermMemorySystem(BaseMemory):
    ...
    async def initialize(self) -> bool:
        ...
        try:
            if not REDIS_AVAILABLE:
                self.logger.warning("Redis not available - short-term memory will use fallback mode")
            ...
            self.logger.warning("Redis unavailable - operating in fallback mode")
            self.is_initialized = True  # Still mark as initialized for fallback mode
            return True
    ...
    async def store(
        ...
        **kwargs
        ...
        """
        if not REDIS_AVAILABLE:
            self.logger.warning("Redis not available - cannot store data")
            return False
    ...
    async def retrieve(
        ...
        **kwargs
        ...
        """
        if not REDIS_AVAILABLE:
            self.logger.warning("Redis not available - cannot retrieve data")
            return None
    ...
    async def update(
        ...
        **kwargs
        ...
        """
        if not REDIS_AVAILABLE:
            self.logger.warning("Redis not available - cannot update data")
            return False
    ...
    async def delete(self, key: str) -> bool:
        ...
        """
        if not REDIS_AVAILABLE:
            self.logger.warning("Redis not available - cannot delete data")
            return False
    ...
    async def search(
        ...
        **kwargs
        ...
        """
        if not REDIS_AVAILABLE:
            self.logger.warning("Redis not available - cannot search data")
            return []
    ...
    async def cleanup(self) -> bool:
        ...
        """
        if not REDIS_AVAILABLE:
            self.logger.warning("Redis not available - cannot cleanup")
            return False
    ...
    async def extend_ttl(self, key: str, additional_seconds: int = None) -> bool:
        ...
        """
        if not REDIS_AVAILABLE:
            self.logger.warning("Redis not available - cannot extend TTL")
            return False
